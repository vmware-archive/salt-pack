# Use Python 2.6
%global pythonver 2.6
%global __python_ver 26
%global __python %{_bindir}/python%{pythonver}
...
BuildRequires:	python%{__python_ver}-devel, gmp-devel >= 4.1
...
%changelog
* Wed Sep  9 2015 Packaging <packaging@saltstack.com> - 2.6.1-2
- Remove _fastmath extension module to address timing vulnerability
  - Fix from python-crypto2.6-2.6.1-2.el6.src

* Tue Sep  8 2015 Packaging <packaging@saltstack.com> - 2.6.1-1
- update this to function on RedHat 5

* Wed May 11 2011 Andy Grimm <agrimm@eucalyptus.com> - 2.3-5
- adapt this package for python 2.6 in EPEL
