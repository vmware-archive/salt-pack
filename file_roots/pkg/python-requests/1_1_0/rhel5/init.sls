...
{{ macros.requires(sls_name, pkg_data) }}
    ...
    - sources:
      ...
      - salt://{{slspath}}/sources/{{sls_name}}-system-urllib3.patch
      - salt://{{slspath}}/sources/{{sls_name}}-system-chardet-not-charade.patch
      - salt://{{slspath}}/sources/{{sls_name}}-system-cert-bundle-el5.patch
{% endif %}
