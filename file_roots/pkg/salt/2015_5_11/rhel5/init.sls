...
{{ macros.requires(sls_name, pkg_data) }}
    ...
    - sources:
#      - {{ macros.pypi_source("salt", "2015.5.11") }}
#      - {{ macros.pypi_source("SaltTesting", "2016.7.22") }}
      - salt://{{slspath}}/sources/salt-2015.5.11.tar.gz
      - salt://{{slspath}}/sources/SaltTesting-2016.7.22.tar.gz
