python343:
  pkgbuild.built:
    ...
    - template: jinja
    - deps:
      - https://dl.iuscommunity.org/pub/ius/stable/Redhat/7/x86_64/python34u-libs-3.4.3-2.ius.el7.x86_64.rpm
      - https://dl.iuscommunity.org/pub/ius/stable/Redhat/7/x86_64/python34u-3.4.3-2.ius.el7.x86_64.rpm
      - https://dl.iuscommunity.org/pub/ius/stable/Redhat/7/x86_64/python34u-pip-7.1.0-1.ius.el7.noarch.rpm
      - https://dl.iuscommunity.org/pub/ius/stable/Redhat/7/x86_64/python34u-setuptools-18.0.1-1.ius.el7.noarch.rpm
    - tgt: epel-7-x86_64
    - sources: 
      - salt://{{slspath}}/sources/python-tornado-cert.patch
