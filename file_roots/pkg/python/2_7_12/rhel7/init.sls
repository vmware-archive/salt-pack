...
{{ macros.requires(sls_name, pkg_data) }}
    ...
    - sources:
      - salt://{{slspath}}/sources/Python-2.7.12.tar.xz
      ...
      - salt://{{slspath}}/sources/00165-crypt-module-salt-backport.patch
      - salt://{{slspath}}/sources/pyfuntop.stp
      - salt://{{slspath}}/sources/00167-disable-stack-navigation-tests-when-optimized-in-test_gdb.patch
      ...
      - salt://{{slspath}}/sources/00211-fix-test-pyexpat-failure.patch
      ...
      - salt://{{slspath}}/sources/00185-urllib2-honors-noproxy-for-ftp.patch
      - salt://{{slspath}}/sources/libpython.stp
      - salt://{{slspath}}/sources/00010-2.7.12-binutils-no-dep.patch
      - salt://{{slspath}}/sources/00173-workaround-ENOPROTOOPT-in-bind_port.patch
      - salt://{{slspath}}/sources/00157-uid-gid-overflows.patch
      - salt://{{slspath}}/sources/00174-fix-for-usr-move.patch
      ...
      - salt://{{slspath}}/sources/00169-avoid-implicit-usage-of-md5-in-multiprocessing.patch
      - salt://{{slspath}}/sources/00181-allow-arbitrary-timeout-in-condition-wait.patch
      ...
      - salt://{{slspath}}/sources/00189-gdb-py-bt-dont-raise-exception-from-eval.patch
      ...
      - salt://{{slspath}}/sources/00168-distutils-cflags.patch
      ...
      - salt://{{slspath}}/sources/00191-disable-NOOP.patch
      - salt://{{slspath}}/sources/00112-2.7.12-debug-build.patch
      - salt://{{slspath}}/sources/00200-skip-thread-test.patch
      - salt://{{slspath}}/sources/00193-enable-loading-sqlite-extensions.patch
      ...
      - salt://{{slspath}}/sources/pynche
      - salt://{{slspath}}/sources/00198-add-rewheel-module.patch
      ...
      - salt://{{slspath}}/sources/00187-add-RPATH-to-pyexpat.patch
