...
{{ macros.requires(sls_name, pkg_data) }}
    ...
    - sources:
      - salt://{{slspath}}/sources/pip-1.5.6.tar.gz
      - salt://{{slspath}}/sources/pip-1.5rc1-allow-stripping-prefix-from-wheel-RECORD-files.patch
      - salt://{{slspath}}/sources/local-dos.patch
{% endif %}
