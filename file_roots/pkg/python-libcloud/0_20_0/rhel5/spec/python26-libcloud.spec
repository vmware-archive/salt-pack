%{!?python_sitelib: %global python_sitelib %(python26 -c "from distutils.sysconfig import get_python_lib; print(get_python_lib())")}
...
%changelog
* Tue Jan 12 2016 SaltStack Packaging Team <p[ackaging@saltstack.com> - 0.20.0-1
- Libcloud 0.20.0 release

* Mon Sep 28 2015 SaltStack Packaging Team <p[ackaging@saltstack.com> - 0.18.0-1
- Libcloud 0.18.0 release

* Fri Sep 11 2015 Erik Johnson <erik@saltstack.com> - 0.17.0-3
- Patched to fix LIBCLOUD-714

* Fri Apr 10 2015 Erik Johnson <erik@saltstack.com> - 0.17.0-2
- Rebuilt for SSE repo
