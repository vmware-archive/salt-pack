...
%package -n python%{?__python_ver}-%{pyname}
Summary: %summary

%if 0%{?backport_rhel6}
Provides:   python-%{pyname}
Provides:   python%{?__python_ver}-%{pyname}
%else
%{?python_provide:%python_provide python2-%{pyname}}
%endif

%description -n python%{?__python_ver}-%{pyname} %_description
...
%files -n python%{?__python_ver}-%{pyname}
%doc README.md
%{python2_sitelib}/*
