...
Summary: Support for using OpenSSL in python %{?pybasever} scripts
Name: python%{?__python_ver}-m2crypto
Version: 0.21.1
Release: 5%{?dist}
...
BuildRequires: openssl-devel, python%{?__python_ver}-devel
BuildRequires: perl, pkgconfig, swig, which

BuildRoot: %(mktemp -ud %{_tmppath}/%{name}-%{version}-%{release}-XXXXXX)

%description
This package allows you to call OpenSSL functions from python %{?pybasever}
scripts.
...
# Fix private .so file permissions
chmod 0755 $RPM_BUILD_ROOT/%{python_sitearch}/M2Crypto/__m2crypto.so
...
* Tue Feb 22 2011 Garrett Holmstrom <gholms@fedoraproject.org> - 0.21.1-3
- Rebuilt against the correct target

* Tue Feb 22 2011 Garrett Holmstrom <gholms@fedoraproject.org> - 0.21.1-2
- Forked python26-m2crypto for el5 from Fedora's m2crypto-0.21.1-2
